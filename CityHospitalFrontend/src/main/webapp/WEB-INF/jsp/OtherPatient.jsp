...
<div class="container register">
	<div class="row">
 		<div class="col-md-3 register-left">
         	...
         	<h2>CITY</h2>
            <h2>HOSPITAL</h2>
            <input type="submit" name="" value=" Other Patients"/><br/>
      	</div>
		<div class="col-md-9 register-right">
         	...
         	<form action="<c:url value='/insertOtherPatient'/>" method="post">
            	<div class="tab-content" id="myTabContent">
                	<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                 		<h3 class="register-heading">OTHER PATIENTS</h3>
...
<table align="center" cellspacing="3" cellpadding="3" class="table table-condensed">
	...
	<c:forEach items="${otherPatientList}" var= "otherPatient">
	<tr bgcolor="#b3c6ff">
		<td>${otherPatient.patientId}</td>
		<td>${otherPatient.patientName}</td>
		<td>${otherPatient.patientAge}</td>
		<td>${otherPatient.patientAdmitDate}</td>
		<td>${otherPatient.relativeMobNo}</td>
		<td>${otherPatient.patientAddress}</td>
		
		<td>
			<a href="<c:url value='/deleteOtherPatient/${otherPatient.patientId}'></c:url>">Delete</a>
				&nbsp;&nbsp;|&nbsp;&nbsp;
			<a href="<c:url value='/editOtherPatient/${otherPatient.patientId}'></c:url>">Edit</a>
		</td>
	</tr>
	</c:forEach>
</table>
